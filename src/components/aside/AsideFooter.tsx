...
const AsideFooter = () => {
  ...
  return (
    <div className="p-4 mt-auto border-t border-gray-200">
      ...
      <button onClick={handleLogout} className="cursor-pointer mt-2 w-full flex items-center gap-3 px-3 py-2.5 rounded-lg text-red-500 hover:bg-red-50 transition-colors group">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="24"
          height="24"
